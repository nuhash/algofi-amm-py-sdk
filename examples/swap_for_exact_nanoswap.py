...
if pool.pool_status == PoolStatus.UNINITIALIZED:
    ...
    swap_exact_for_txn = pool.get_swap_for_exact_txns(sender, swap_input_asset, swap_asset_scaled_amount, amount_to_receive=exact_scaled_amount_to_receive, fee=4000)
