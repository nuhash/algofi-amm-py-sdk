...
swap_asset_amount = 0.01
min_amount_to_receive = 0.001
...
if pool.pool_status == PoolStatus.UNINITIALIZED:
    ...
    swap_exact_for_txn = pool.get_swap_exact_for_txns(sender, swap_input_asset, swap_asset_scaled_amount, min_amount_to_receive=min_scaled_amount_to_receive, fee=5000)
