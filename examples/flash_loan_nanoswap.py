...
if pool.pool_status == PoolStatus.UNINITIALIZED:
    ...
    swap_exact_for_txn = pool.get_swap_exact_for_txns(sender, swap_input_asset, swap_asset_amount, min_amount_to_receive=min_amount_to_receive, fee=5000)
    flash_loan_txn = pool.get_flash_loan_txns(sender, swap_input_asset, flash_loan_amount, group_transaction=swap_exact_for_txn)
